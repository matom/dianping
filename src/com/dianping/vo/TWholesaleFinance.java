 ...
 */
@javax.persistence.Table(name = "t_wholesale_finance", schema = "", catalog = "dianping")
@Entity
public class TWholesaleFinance {
    private String id;
    ...
    @javax.persistence.Column(name = "DISTRIBUTOR_ID")
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        TWholesaleFinance that = (TWholesaleFinance) o;
